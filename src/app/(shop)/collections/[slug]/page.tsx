...
export default async function Page({
	...
	return ( <div className='flex flex-row gap-8'><Link href={"/"} className='text-bold underline bg-green-500'> Currently We are unAvailable, visit back home page</Link>
	<button type='button' className='flex bg-blue-500'> Return Back</button></div>
	...
	// 					<span className="font-medium text-foreground">{plants.length}</span>{" "}
	// 					unique varieties.
	// 				</p>
	// 			</div>
	...
	// 						<Leaf
	// 							className="w-8 h-8 text-muted-foreground opacity-40"
	// 							strokeWidth={1}
	// 						/>
	// 					</div>
	...
	// 						We are currently cultivating new plants for this category. Please
	// 						check back soon.
	// 					</p>
	// 				</div>
	// 			) : (
