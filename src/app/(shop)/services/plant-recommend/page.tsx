...
import { Sun, CloudRain, ShieldCheck, AlertTriangle, Droplets, Droplet } from 'lucide-react';
...
export default function PlantFinderPage() {
  ...
  const isFormComplete = preferences.sunlight && preferences.needsPetSafe !== null && preferences.wateringHabit;
    ...
    <div className="min-h-screen bg-gray-50/50 py-12 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900">Find Your Perfect Plant</h1>
          <p className="text-lg text-gray-500">Answer 3 quick questions to get your match.</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold flex items-center gap-2">
              <Sun className="text-amber-500 w-5 h-5" /> How much light does your space get?
            </h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold flex items-center gap-2">
              <ShieldCheck className="text-blue-500 w-5 h-5" /> Do you have curious pets?
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <OptionCard 
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold flex items-center gap-2">
              <Droplets className="text-cyan-500 w-5 h-5" /> What's your watering style?
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <OptionCard 
                title={<><Droplet className="w-4 h-4"/> Forgetful</>} 
              ...
              />
              <OptionCard 
                title={<><CloudRain className="w-4 h-4"/> Helicopter Parent</>} 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
              {recommended.length > 0 ? (
                ...
                <div className="col-span-full text-center p-8 bg-gray-50 rounded-xl border">
                  ...
                  <p className="text-gray-500">Try adjusting your preferences to see more options.</p>
                </div>
              )}
            </div>
          </div>
