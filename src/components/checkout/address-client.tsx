...
function OrderDetailsAccordions({
	items,
	total,
	isDesktop = false,
}: {
						...
						<div className="space-y-3 pt-2">
							...
							<div className="flex justify-between text-gray-600 text-sm items-center">
								<span className="flex items-center gap-1">
									Shipping <Info className="h-3 w-3" />
								</span>
		...
		<div className="hidden md:flex overflow-x-auto pb-6 gap-4 snap-x hide-scrollbar">
			...
			<div className="shrink-0 w-[300px] snap-start h-[180px]">
				<AddressSheet
					user={user}
					label={
						<div className="flex flex-col items-center justify-center h-full gap-2 text-gray-500 border-2 border-dashed rounded-2xl cursor-pointer hover:border-black transition-all">
							...
							<div className="flex gap-3 mt-auto pt-2">
								...
								>
									<AddressSheet
										...
										address={addr}
										label={
											<div className="py-1.5 border border-gray-300 rounded-full text-[10px] font-bold text-center bg-white hover:border-black transition-all">
												EDIT
											</div>
										}
									/>
	...
	if (addresses.length === 0)
		return (
			<div className="md:hidden p-4">
				<AddressSheet user={user} label="Add Address" />
			</div>
		);
			...
			{activeAddress && (
				<div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
					...
					<AddressSheet
						user={user}
						label={
							<span className="text-xs font-bold text-blue-600 underline">
