...
export function EditorialLayout({
	...
	const heroMobileCard = EDITORIAL_CARDS_DATA.find(
		(card): card is EditorialHeroProps => card.type === "hero",
	);
	const minimalistMobileCard = EDITORIAL_CARDS_DATA.find(
		(card): card is MinimalistProps => card.type === "minimalist",
	);
	const ledGlowMobileCard = EDITORIAL_CARDS_DATA.find(
		(card): card is GuaranteeCardProps => card.type === "led-glow",
	);
	return (
