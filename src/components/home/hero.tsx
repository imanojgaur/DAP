	...
	return (
		<section className="px-4 pt-4 md:px-8 md:pt-8">
			<div className="relative w-full h-[80vh] md:h-[90vh] rounded-[2rem] md:rounded-[3rem] overflow-hidden group">
				...
				<div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1545241047-6083a3684587?q=80&w=3000')] bg-cover bg-center transition-transform duration-[2000ms] group-hover:scale-110" />
