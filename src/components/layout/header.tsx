...
// browser load drawers parelle to other chunks
const AddToCartDrawer = dynamic(() =>
	import("../cart/cart-drawer").then((mod) => mod.AddToCartDrawer),
);
const HeaderCartTrigger = dynamic(() =>
	import("../cart/cart-drawer").then((mod) => mod.HeaderCartTrigger),
);
