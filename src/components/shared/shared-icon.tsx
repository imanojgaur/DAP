...
export function ClassicClusterLogo({ className }: { className?: string }) {
	return (
		<svg
			...
			viewBox="0 0 160 50"
			className={cn(
				"h-8 md:h-12 w-auto text-[#111111] cursor-pointer hover:text-emerald-700 transition-colors duration-300",
				className,
			)}
			aria-label="DAP Logo"
			role="img"
	...
	return (
		...
		>
			...
			>
				...
				<path
					d="M20 30 C5 30, 5 15, 12 12 C18 15, 22 20, 20 30 Z"
					fill="#2E7D32"
					opacity="0.1"
				/>
				<path
					d="M22 20 C35 25, 42 15, 38 5 C32 2, 25 5, 22 20 Z"
					fill="#2E7D32"
					opacity="0.1"
				/>
	...
	return (
		...
		>
			<g style={{ mixBlendMode: "multiply" }}>
				<path
					d="M 20 8 C 35 8, 42 22, 42 38 C 27 38, 20 24, 20 8 Z"
					fill="#065F46"
					opacity="0.9"
				/>
				<path
					d="M 12 20 C 27 20, 32 32, 32 45 C 17 45, 12 33, 12 20 Z"
					fill="#10B981"
					opacity="0.9"
				/>
			</g>
